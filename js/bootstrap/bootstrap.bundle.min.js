...
var bootstrap = (function(t, e) {
  ...
  function u(t, e) {
    var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
      ...
      r = h(e, "left"),
      o = n ? -1 : 1;
    return (t.top += i * o), (t.bottom += i * o), (t.left += r * o), (t.right +=
      r * o), t;
  }
  function d(t, e) {
    var n = "x" === e ? "Left" : "Top",
  ...
  function v(t, e) {
    ...
    if (((d.marginTop = 0), (d.marginLeft = 0), !n && i)) {
      ...
      (d.top -= f - p), (d.bottom -= f - p), (d.left -= h - g), (d.right -=
        h - g), (d.marginTop = p), (d.marginLeft = g);
    }
    return (n ? e.contains(l) : e === l && "BODY" !== l.nodeName) &&
      (d = u(d, e)), d;
  }
  function E(t) {
  ...
  function T(t) {
    var e = t.nodeName;
    return (
      "BODY" !== e && "HTML" !== e && ("fixed" === r(t, "position") || T(o(t)))
    );
  }
  function b(t, e, n, i) {
    var r = { top: 0, left: 0 },
    ...
    if ("viewport" === i) r = E(a);
      ...
      if ("HTML" !== l.nodeName || T(a)) r = c;
        ...
        var h = g(),
          u = h.height,
          d = h.width;
        (r.top += c.top - c.marginTop), (r.bottom = u + c.top), (r.left +=
          c.left - c.marginLeft), (r.right = d + c.left);
      }
    }
  ...
  function D(t, e, n) {
    ...
    var i = O(t),
      ...
      l = o ? "height" : "width",
      c = o ? "width" : "height";
    return (r[s] = e[s] + e[l] / 2 - i[l] / 2), (r[a] =
      n === a ? e[a] - i[c] : e[y(a)]), r;
  }
  function S(t, e) {
  ...
  function N(t, e, n) {
    return (void 0 === n ? t : t.slice(0, w(t, "name", n))).forEach(function(
      t
    ) {
      t.function &&
  ...
  function L() {
    if (!this.state.isDestroyed) {
      ...
      (t.offsets.reference = I(
        ...
        t.offsets.reference,
        t.placement
      )), (t.offsets.popper.position = "absolute"), (t = N(
        this.modifiers,
        t
  ...
  function H() {
    return (this.state.isDestroyed = !0), P(this.modifiers, "applyStyle") &&
      (
  ...
  function k(t, e, n, i) {
    var r = "BODY" === t.nodeName,
      o = r ? window : t;
    o.addEventListener(e, n, { passive: !0 }), r ||
      k(s(o.parentNode), e, n, i), i.push(o);
  }
  function W(t, e, n, i) {
    ...
    return k(
      ...
      n.updateBound,
      n.scrollParents
    ), (n.scrollElement = r), (n.eventsEnabled = !0), n;
  }
  function x() {
      ...
      return t
        .reduce(function(t, e) {
          return "" === t[t.length - 1] && -1 !== ["+", "-"].indexOf(e)
            ...
            : s ? ((t[t.length - 1] += e), (s = !1), t) : t.concat(e);
        }, [])
        .map(function(t) {
          return Q(t, r, e, n);
        });
  ...
  for (
    var X = (function() {
        ...
        return (o = i()), (e.fn.emulateTransitionEnd = r), a.supportsTransitionEnd() &&
          (e.event.special[a.TRANSITION_END] = n()), a;
      })(),
      q = function(t, e, i) {
      ...
      Z = (function() {
          ...
          o = (function() {
            ...
            return (n.close = function(t) {
              ...
              var n = X.getSelectorFromElement(t),
                i = !1;
              return n && (i = e(n)[0]), i ||
                (i = e(t).closest("." + r.ALERT)[0]), i;
            }), (n._triggerCloseEvent = function(t) {
              var n = e.Event(i.CLOSE);
              return e(t).trigger(n), n;
            }), (n._removeElement = function(t) {
              var n = this;
              e(t).removeClass(r.SHOW), X.supportsTransitionEnd() &&
              e(t).hasClass(r.FADE)
                ? e(t)
        ...
        ), (e.fn[t] = o._jQueryInterface), (e.fn[t].Constructor = o), (e.fn[
          t
        ].noConflict = function() {
      ...
      J = (function() {
                ...
                if (s) {
                  ...
                  if (t) {
                    if (
                      ...
                      return;
                    (s.checked = !e(this._element).hasClass(i.ACTIVE)), e(
                      s
                    ).trigger("change");
                  }
                  s.focus(), (n = !1);
        ...
        return e(document)
          ...
          }), (e.fn[t] = s._jQueryInterface), (e.fn[t].Constructor = s), (e.fn[
          t
        ].noConflict = function() {
      ...
      $ = (function() {
          ...
          h = (function() {
            function r(t, n) {
              (this._items = null), (this._interval = null), (this._activeElement = null), (this._isPaused = !1), (this._isSliding = !1), (this.touchTimeout = null), (this._config = this._getConfig(
                n
              )), (this._element = e(t)[0]), (this._indicatorsElement = e(
                this._element
              ).find(f.INDICATORS)[0]), this._addEventListeners();
            }
            var h = r.prototype;
            return (h.next = function() {
              ...
              t || (this._isPaused = !0), e(this._element).find(
                f.NEXT_PREV
              )[0] &&
              ...
              e(this._element).off(i), e.removeData(
                this._element,
                n
                ...
                (
                  ...
                  ("ontouchstart" in document.documentElement) &&
                    e(this._element).on(l.TOUCHEND, function() {
                      t.pause(), t.touchTimeout && clearTimeout(t.touchTimeout), (t.touchTimeout = setTimeout(
                        function(e) {
                          return t.cycle(e);
                        },
              ...
              return (this._items = e.makeArray(
              ...
              if (
                ...
                (this._isSliding = !0), g &&
                  this.pause(), this._setActiveIndicatorElement(d);
                      ...
                      e(h)
                        .one(X.TRANSITION_END, function() {
                          e(d)
                            ...
                            .addClass(
                              c.ACTIVE
                            ), e(h).removeClass(c.ACTIVE + " " + r + " " + i), (s._isSliding = !1), setTimeout(function() {
              ...
              return this.each(function() {
                ...
                if (
                  (
                    i || ((i = new r(this, s)), e(this).data(n, i)),
                    "number" == typeof t
                  )
                )
                  i.to(t);
              ...
              if (i) {
                ...
                if (o && e(o).hasClass(c.CAROUSEL)) {
                  ...
                  a && (s.interval = !1), r._jQueryInterface.call(e(o), s), a &&
                    e(o).data(n).to(a), t.preventDefault();
                }
              }
            }), q(r, null, [
              {
        ...
        }), (e.fn[t] = h._jQueryInterface), (e.fn[t].Constructor = h), (e.fn[
          t
        ].noConflict = function() {
      ...
      tt = (function() {
            ...
            return (f.toggle = function() {
              ...
              if (
                ...
                if (
                  (
                    this._parent &&
                      ((r = e.makeArray(
                        e(this._parent).children().children(c.ACTIVES)
                      )).length ||
                        (r = null)),
                  ...
                  if ((e(this._element).trigger(l), !l.isDefaultPrevented())) {
                    ...
                    e(this._element)
                      ...
                      .addClass(a.COLLAPSING), (this._element.style[
                      f
                    ...
                    var h = function() {
                      e(t._element)
                        ...
                        .addClass(a.COLLAPSE)
                        .addClass(a.SHOW), (t._element.style[f] =
                        ""), t.setTransitioning(!1), e(t._element).trigger(
                        s.SHOWN
                      );
                    };
                    if (X.supportsTransitionEnd()) {
                      ...
                      e(this._element)
                        ...
                        .emulateTransitionEnd(600), (this._element.style[f] =
                        this._element[u] + "px");
                    } else h();
                  }
                }
              ...
              if (!this._isTransitioning && e(this._element).hasClass(a.SHOW)) {
                ...
                if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
                  ...
                  (this._element.style[i] = ""), X.supportsTransitionEnd()
                    ? e(this._element)
              ...
              return (n = e.extend({}, r, n)), (n.toggle = Boolean(
                n.toggle
              )), X.typeCheckConfig(t, n, o), n;
              ...
              if (t) {
                ...
                n.length &&
                  e(n).toggleClass(a.COLLAPSED, !i).attr("aria-expanded", i);
              }
        ...
        }), (e.fn[t] = f._jQueryInterface), (e.fn[t].Constructor = f), (e.fn[
          t
        ].noConflict = function() {
  ...
  var st =
    ...
    lt = function() {
      return void 0 === at &&
        (at = -1 !== navigator.appVersion.indexOf("MSIE 10")), at;
    },
    ct = function(t, e) {
      if (!(t instanceof e))
      ...
      modifiers: {
        ...
        offset: {
          ...
          fn: function(t, e) {
            var n = e.offset,
              ...
              a = i.split("-")[0],
              l = void 0;
            return (l = V(+n) ? [+n, 0] : Y(n, o, s, a)), "left" === a
              ...
              : "right" === a
                ...
                : "top" === a
                  ...
                  : "bottom" === a &&
                    ((o.left += l[0]), (o.top += l[1])), (t.popper = o), t;
          },
          offset: 0,
        },
        preventOverflow: {
        ...
        keepTogether: {
          ...
          fn: function(t) {
            var e = t.offsets,
              ...
              l = s ? "left" : "top",
              c = s ? "width" : "height";
            return n[a] < o(i[l]) && (t.offsets.popper[l] = o(i[l]) - n[c]), n[
              l
            ] > o(i[a]) && (t.offsets.popper[l] = o(i[a])), t;
          },
        },
        arrow: {
          order: 500,
          ...
          fn: function(t, e) {
            ...
            var i = t.placement.split("-")[0],
              ...
              d = l ? "bottom" : "right",
              p = O(n)[c];
            a[d] - p < s[h] && (t.offsets.popper[h] -= s[h] - (a[d] - p)), a[
              h
            ] +
              p >
              s[d] && (t.offsets.popper[h] += a[h] + p - s[d]);
            var g = a[h] + a[c] / 2 - p / 2,
            ...
            return (v = Math.max(
              Math.min(s[c] - p, v),
              0
            )), (t.arrowElement = n), (t.offsets.arrow = {}), (t.offsets.arrow[
              h
            ] = Math.round(v)), (t.offsets.arrow[u] = ""), t;
          },
          element: "[x-arrow]",
        },
        flip: {
        ...
        inner: {
          ...
          fn: function(t) {
            ...
            return (r[s ? "left" : "top"] =
              o[n] - (a ? r[s ? "width" : "height"] : 0)), (t.placement = y(
              e
            )), (t.offsets.popper = m(r)), t;
          },
        },
        hide: {
          order: 800,
        ...
        computeStyle: {
          ...
          fn: function(t, e) {
            ...
            if (
              ...
              (c[d] = "translate3d(" + p + "px, " + g + "px, 0)"), (c[
                h
              ] = 0), (c[u] = 0), (c.willChange = "transform");
            else {
              var m = "bottom" === h ? -1 : 1,
                v = "right" === u ? -1 : 1;
            ...
            return (t.attributes = ut({}, E, t.attributes)), (t.styles = ut(
              {},
              c,
              t.styles
            )), (t.arrowStyles = ut({}, t.offsets.arrow, t.arrowStyles)), t;
          },
          gpuAcceleration: !0,
          x: "bottom",
          y: "right",
        ...
        applyStyle: {
          ...
          enabled: !0,
          fn: function(t) {
            return F(t.instance.popper, t.styles), j(
              t.instance.popper,
              t.attributes
            ), t.arrowElement &&
              Object.keys(t.arrowStyles).length &&
              F(t.arrowElement, t.arrowStyles), t;
          },
    ...
    _t = (function() {
      function t(e, n) {
        ...
        ct(this, t), (this.scheduleUpdate = function() {
        ...
        }), (this.update = st(this.update.bind(this))), (this.options = ut(
          {},
          t.Defaults,
          o
        )), (this.state = {
          ...
          isCreated: !1,
          scrollParents: [],
        }), (this.reference = e.jquery ? e[0] : e), (this.popper = n.jquery
          ? n[0]
  ...
  (_t.Utils = ("undefined" != typeof window
    ? window
    : global).PopperUtils), (_t.placements = dt), (_t.Defaults = mt);
  var vt = (function() {
      ...
      var t = "dropdown",
        ...
        u = (function() {
          ...
          return (u.toggle = function() {
              ...
              if ((r._clearMenus(), !n)) {
                ...
                if ((e(t).trigger(o), !o.isDefaultPrevented())) {
                  ...
                  e(t).hasClass(a.DROPUP) &&
                    ...
                    "aria-expanded",
                    !0
                  ), e(this._menu).toggleClass(a.SHOW), e(t)
                    .toggleClass(a.SHOW)
            ...
            e.removeData(this._element, n), e(this._element).off(
              i
            ...
            return (n = e.extend(
              ...
              n
            )), X.typeCheckConfig(t, n, this.constructor.DefaultType), n;
            ...
            var t = e(this._element).parent(),
              n = c.BOTTOM;
            return t.hasClass(a.DROPUP)
              ? (
                  (n = c.TOP),
                  e(this._menu).hasClass(a.MENURIGHT) && (n = c.TOPEND)
                )
              : e(this._menu).hasClass(a.MENURIGHT) && (n = c.BOTTOMEND), n;
            ...
            return this._inNavbar &&
              (i.modifiers.applyStyle = { enabled: !this._inNavbar }), i;
          }), (r._jQueryInterface = function(t) {
            return this.each(function() {
              var i = e(this).data(n),
              ...
              if (
                (
                  i || ((i = new r(this, o)), e(this).data(n, i)),
                  "string" == typeof t
                )
              ) {
            ...
            if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
              for (
                var i = e.makeArray(e(l.DATA_TOGGLE)), o = 0;
                o < i.length;
                o++
              ) {
                ...
                if (f) {
                  ...
                  if (
                    ...
                    e(c).trigger(d), d.isDefaultPrevented() ||
                      (
                        "ontouchstart" in document.documentElement &&
      ...
      return e(document)
        ...
        .on(s.CLICK_DATA_API, l.FORM_CHILD, function(t) {
          t.stopPropagation();
        }), (e.fn[t] = u._jQueryInterface), (e.fn[t].Constructor = u), (e.fn[
        t
      ].noConflict = function() {
    ...
    Et = (function() {
        ...
        c = (function() {
          function i(t, n) {
            (this._config = this._getConfig(
              n
            )), (this._element = t), (this._dialog = e(t).find(
              l.DIALOG
          ...
          return (c.toggle = function(t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
              ...
              e(this._element).trigger(i), this._isShown ||
                ...
                (
                  ...
                  e(this._element).on(s.CLICK_DISMISS, l.DATA_DISMISS, function(
                    t
                  ) {
                    return n.hide(t);
                  }),
            ...
            if (
              ...
              if (
                ...
                var r =
                  ...
                  e(this._element).hasClass(a.FADE);
                r &&
                  (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), e(
                  document
                ).off(s.FOCUSIN), e(this._element).removeClass(a.SHOW), e(
                  this._element
                ).off(s.CLICK_DISMISS), e(this._dialog).off(
                  s.MOUSEDOWN_DISMISS
                ), r
                  ? e(this._element)
            ...
            e.removeData(this._element, "bs.modal"), e(
              window,
              document,
              this._element,
              this._backdrop
            ...
            (this._element.parentNode &&
              ...
              "aria-hidden"
            ), (this._element.scrollTop = 0), i && X.reflow(this._element), e(
              this._element
            ).addClass(a.SHOW), this._config.focus && this._enforceFocus();
            var r = e.Event(s.SHOWN, { relatedTarget: t }),
              o = function() {
                n._config.focus &&
                  n._element.focus(), (n._isTransitioning = !1), e(
                  n._element
                ).trigger(r);
              };
            i
            ...
            (this._element.style.display = "none"), this._element.setAttribute(
              ...
              e(document.body).removeClass(
                a.OPEN
              ), t._resetAdjustments(), t._resetScrollbar(), e(t._element).trigger(s.HIDDEN);
            });
            ...
            }), e(l.STICKY_CONTENT + ", " + l.NAVBAR_TOGGLER).each(function(
              t,
              n
            ) {
            ...
            return this.each(function() {
              ...
              if (
                (
                  r || ((r = new i(this, o)), e(this).data("bs.modal", r)),
                  "string" == typeof t
                )
              ) {
      ...
      }), (e.fn[t] = c._jQueryInterface), (e.fn[t].Constructor = c), (e.fn[
        t
      ].noConflict = function() {
    ...
    Tt = (function() {
      ...
      var t = "tooltip",
        ...
        d = (function() {
          ...
          return (d.enable = function() {
            ...
            clearTimeout(this._timeout), e.removeData(
              this.element,
              this.constructor.DATA_KEY
            ), e(this.element).off(this.constructor.EVENT_KEY), e(this.element)
              .closest(".modal")
              .off("hide.bs.modal"), this.tip &&
              e(
                this.tip
              ).remove(), (this._isEnabled = null), (this._timeout = null), (this._hoverState = null), (this._activeTrigger = null), null !==
              this._popper &&
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              e(o).data(this.constructor.DATA_KEY, this), e.contains(
                this.element.ownerDocument.documentElement,
                this.tip
              ) || e(o).appendTo(u), e(this.element).trigger(
              ...
              })), e(o).addClass(f.SHOW), "ontouchstart" in
                document.documentElement &&
                e("body").children().on("mouseover", null, e.noop);
              var d = function() {
                t.config.animation && t._fixTransition();
                var n = t._hoverState;
                (t._hoverState = null), e(t.element).trigger(
            ...
            var n = this,
              ...
              o = function() {
                n._hoverState !== l.SHOW &&
                  ...
                  "aria-describedby"
                ), e(n.element).trigger(n.constructor.Event.HIDDEN), null !==
            ...
            return (this.tip = this.tip || e(this.config.template)[0]), this
              .tip;
            ...
            (n = n || e(t.currentTarget).data(i)) ||
              ...
              ] = !0), e(n.getTipElement()).hasClass(f.SHOW) ||
            n._hoverState === l.SHOW
              ? (n._hoverState = l.SHOW)
              : (
            ...
            (n = n || e(t.currentTarget).data(i)) ||
              ...
              (n._activeTrigger[
                "focusout" === t.type ? u.FOCUS : u.HOVER
            ...
            return "number" ==
              ...
              (n.delay = { show: n.delay, hide: n.delay }), "number" ==
              typeof n.title && (n.title = n.title.toString()), "number" ==
              typeof n.content &&
              (n.content = n.content.toString()), X.typeCheckConfig(
              t,
              n,
            ...
            this._cleanTipClass(), this.addAttachmentClass(
            ...
            return this.each(function() {
              ...
              if (
                ...
                (
                  n || ((n = new i(this, r)), e(this).data("bs.tooltip", n)),
                  "string" == typeof t
                )
              ) {
      ...
      return (e.fn[t] = d._jQueryInterface), (e.fn[t].Constructor = d), (e.fn[
        t
      ].noConflict = function() {
    ...
    bt = (function() {
          ...
          return (h.isWithContent = function() {
            ...
            return this.each(function() {
              ...
              if (
                ...
                (
                  n || ((n = new f(this, i)), e(this).data("bs.popover", n)),
                  "string" == typeof t
                )
              ) {
                if ("undefined" == typeof n[t])
      ...
      return (e.fn[t] = f._jQueryInterface), (e.fn[t].Constructor = f), (e.fn[
        t
      ].noConflict = function() {
        return (e.fn[t] = i), f._jQueryInterface;
      }), f;
        ...
        c = (function() {
          function n(t, n) {
            ...
            (this._element = t), (this._scrollElement =
              "BODY" === t.tagName
                ? window
                : t), (this._config = this._getConfig(n)), (this._selector =
              this._config.target +
              " " +
              a.NAV_LINKS +
              "," +
              ...
              this._config.target +
              " " +
              a.DROPDOWN_ITEMS), (this._offsets = []), (this._targets = []), (this._activeTarget = null), (this._scrollHeight = 0), e(
              this._scrollElement
            ).on(o.SCROLL, function(t) {
              return i._process(t);
          ...
          return (c.refresh = function() {
            ...
            (this._offsets = []), (this._targets = []), (this._scrollHeight = this._getScrollHeight()), e
            ...
            e.removeData(this._element, "bs.scrollspy"), e(
              this._scrollElement
            ).off(
              ".bs.scrollspy"
            ...
            if ("string" != typeof (n = e.extend({}, i, n)).target) {
              ...
              o || ((o = X.getUID(t)), e(n.target).attr("id", o)), (n.target =
                "#" + o);
            }
            ...
            return this.each(function() {
              ...
              if (
                (
                  i || ((i = new n(this, r)), e(this).data("bs.scrollspy", i)),
                  "string" == typeof t
                )
              ) {
                if ("undefined" == typeof i[t])
    ...
    At = (function() {
      var t = e.fn.tab,
        ...
        o = (function() {
          ...
          return (o.show = function() {
            ...
            l && c
              ? e(l).one(X.TRANSITION_END, f).emulateTransitionEnd(150)
              : f(), l && e(l).removeClass(i.SHOW);
          }), (o._transitionComplete = function(t, n, o, s) {
            if (n) {
              e(n).removeClass(i.ACTIVE);
              var a = e(n.parentNode).find(r.DROPDOWN_ACTIVE_CHILD)[0];
              a && e(a).removeClass(i.ACTIVE), "tab" ===
            ...
            if (
              ...
              l &&
                e(l).find(r.DROPDOWN_TOGGLE).addClass(i.ACTIVE), t.setAttribute(
                "aria-expanded",
                !0
              );
            }
      ...
      return e(document).on(n.CLICK_DATA_API, r.DATA_TOGGLE, function(t) {
        ...
        o._jQueryInterface), (e.fn.tab.Constructor = o), (e.fn.tab.noConflict = function() {
